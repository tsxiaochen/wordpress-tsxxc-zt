...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Tsxc主题设置', 'theme-textdomain' ),
			'menu_title' => __( 'Tsxc主题设置', 'theme-textdomain' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'tsxcc-admin',
     ...
     */
	 function options_page() { ?>
		...
		<h2><?php echo esc_html( $menu['page_title'] ); ?>
		   <span style=" font-size: 15px; "><?php echo version; ?></span>
    <img style="cursor: pointer"
         onclick="window.open('https://www.tsxxc.com/pay/', 'blank')"
         src="<?php bloginfo('template_directory'); ?>/images/赞赏.svg" alt="赞赏支持">
         <img style="cursor: pointer;width: 105px;height: 20px;"
         onclick="window.open('https://docs.tsxxc.com/docs/tsxcc%E4%B8%BB%E9%A2%98/intro/', 'blank')"
         src="<?php bloginfo('template_directory'); ?>/images/bangzhu.jpg" alt="赞赏支持">
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认值', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '单击确认重置。任何主题设置将丢失!', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '主题设置已初始化', 'theme-textdomain' ), 'updated fade' );
